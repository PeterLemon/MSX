// MSX Turbo-R CPU R800 RAM Mode demo by krom (Peter Lemon):
arch msxtr.cpu
output "R800RAM.rom", create
...
CPUMode: // Change CPU Mode To R800 ROM Mode
  ld a,%10000010 // A = Settings: %L00000MM - L = LED (1 = Switched On With CPU Mode), M = CPU Mode (2 = R800 DRAM Mode)
...
CHMSG:
  db 13,"\nMSX Turbo-R CPU R800 RAM Mode\n\n" // Text (Null-Terminated String)
  db 13,"CPU Mode Set To R800 RAM Mode\n\n"
