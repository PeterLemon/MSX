// MSX Megabit ROM Generic (16KB Banks) demo by krom (Peter Lemon):
arch msx.cpu
output "Generic16KB.rom", create
fill $80000 // Set ROM Size (512KB)
...
Start:
  ld h,%10000000 // H = Slot Page 2 ($8000..$BFFF): %PP000000 - PP = Slot Page (0..3)
  ld a,%10001001 // A = Slot Number 1-2: %F000EEBB - F = BASIC(0) Expansion(1), EE = Expansion Slot Number(0..3), BB = BASIC Slot Number(0..3)
  call ENASLT    // CALL System Routine To Select Slot Corresponding To Value In A & Enable Slot To Be Used
