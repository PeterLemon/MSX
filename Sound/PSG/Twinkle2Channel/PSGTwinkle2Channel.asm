// MSX AY8910 PSG Twinkle 2 Channel Song demo by krom (Peter Lemon):
arch msx.cpu
output "PSGTwinkle2Channel.rom", create
...
LoopSong:
  ...
  PSGCHANB: // PSG Channel B
    ...
    ld e,(hl)            // E = PSG Channel B Fine Tune
    inc hl               // Increment Period Table Offset (HL++)
    call WRTPSG          // PSG Write Data (A = PSG Address, E = PSG Data)

    ld a,PSG_COARSE_TUNE_B // A = PSG Channel B Course Tune Address ($03)
    ld e,(hl)              // E = Channel B Course Tune
    call WRTPSG            // PSG Write Data (A = PSG Address, E = PSG Data)
